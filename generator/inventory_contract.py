...
SPECIAL_TEST_FILES = {
    ...
    "desktop launcher and instance discovery contract": "test_desktop_launcher_contract.py",
    ...
    "dependency license inventory and distribution policy contract": "test_dependency_license.py",
