...
def build_actually_additions_advanced_workshop(
    ...
    relay_backbone = (
        ...
        .depends_on(battery_bank)
        .item("actuallyadditions:laser_relay", 4)
        .finish()
    )
    ...
    empowered_restonia = (
        ...
        .depends_on(empowered_line)
        .item("actuallyadditions:empowered_restonia_crystal", 4)
        .finish()
    )
    ...
    empowered_palis = (
        ...
        .depends_on(empowered_line)
        .item("actuallyadditions:empowered_palis_crystal", 4)
        .finish()
    )
    ...
    empowered_diamatine = (
        ...
        .depends_on(empowered_restonia)
        .item("actuallyadditions:empowered_diamatine_crystal", 4)
        .finish()
    )
    ...
    empowered_emeradic = (
        ...
        .depends_on(empowered_palis)
        .item("actuallyadditions:empowered_emeradic_crystal", 4)
        .finish()
    )
    ...
    crystal_stock = (
        ...
        .depends_on(empowered_diamatine, empowered_emeradic)
        .checkmark()
        .finish()
    )
    ...
    reconstructor_cell = (
        chapter.quest(
            "reconstructor_cell",
            "A Dedicated Reconstruction Cell",
    ...
    filtered_collection = (
        ...
        .depends_on(lens_library)
        .item("actuallyadditions:ranged_collector", 2)
        .finish()
    )
    ...
    phantom_network = (
        ...
        .depends_on(filtered_collection, remote_annex)
        .checkmark()
        .finish()
    )
    ...
    unattended_trial = (
        chapter.quest(
            "unattended_workshop_trial",
            "Leave the Workshop Running",
        ...
        .depends_on(mixed_generation, crystal_stock, phantom_network)
        .checkmark()
        .finish()
    )
    ...
    return (
        chapter.quest(
            "advanced_workshop_complete",
            "The Actually Advanced Workshop",
        ...
        .depends_on(unattended_trial)
        .checkmark()
        .reward_item("actuallyadditions:empowered_emeradic_crystal", 4)
        .finish()
    )
