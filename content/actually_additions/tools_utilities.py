...
def build_actually_additions_tools_utilities(
    ...
    speed_one = (
        chapter.quest(
            "drill_speed_1",
            "Spin It Faster",
            "actuallyadditions:drill_speed_1",
        ...
        .depends_on(drill)
        .item("actuallyadditions:drill_speed_1")
        .finish()
    )
    ...
    speed_two = (
        chapter.quest(
            ...
            "actuallyadditions:drill_speed_2",
        ...
        .depends_on(speed_one)
        .item("actuallyadditions:drill_speed_2")
        .finish()
    )

    three_by_three = (
        chapter.quest(
            "drill_three_by_three",
            "Clear a Wider Tunnel",
            "actuallyadditions:drill_size_3",
            "A Size Augment lets the Drill clear a wider area at once. Use it carefully around valuable blocks and machine rooms.",
            40,
            -5,
        )
        .depends_on(speed_two)
        .item("actuallyadditions:drill_size_3")
        .finish()
    )
    ...
    fortune = (
        chapter.quest(
            "drill_fortune",
            "Fortune on Demand",
            "actuallyadditions:drill_fortune",
        ...
        .depends_on(three_by_three)
        .item("actuallyadditions:drill_fortune")
        .finish()
    )
    ...
    silk = (
        chapter.quest(
            "drill_silk_touch",
            "A Delicate Touch",
            "actuallyadditions:drill_silk_touch",
        ...
        .depends_on(three_by_three)
        .item("actuallyadditions:drill_silk_touch")
        .finish()
    )
    ...
    ranged_collector = (
        ...
        .depends_on(phantom_energy, phantom_liquid)
    ...
    item_filter = (
        ...
        .depends_on(ranged_collector)
        .item("actuallyadditions:item_filter")
        .finish()
    )
    ...
    return (
        ...
        .depends_on(drill_complete, item_filter, hand_filler)
        .checkmark()
        .reward_item("actuallyadditions:empowered_diamatine_crystal", 4)
        .finish()
    )
