...
def build_ars_nouveau_foundations(
    project: Project, actually_additions_complete: str
) -> tuple[ChapterBuilder, str]:
    ...
    begin = (
        ...
        .depends_on(actually_additions_complete)
        .checkmark()
        .finish()
    )
    ...
    archwood = (
        ...
        .depends_on(begin)
        .item("ars_nouveau:blue_archwood_log", 8)
        .finish()
    )
    ...
    spellbook = (
        ...
        .depends_on(notebook, source_gems)
    ...
    first_spell = (
        ...
        .depends_on(glyph_form, glyph_effect)
        .checkmark()
    ...
    (
        ...
        .depends_on(first_spell, essence)
    ...
    complete = (
        ...
        .depends_on(first_spell, relay, apparatus, essence)
        .checkmark()
        .reward_item("ars_nouveau:source_gem", 8)
        .finish()
    )
