...
def build_mekanism_endgame_mastery(chapter: ChapterBuilder, stable_reactor: str) -> str:
    ...
    sps_parts = (
        ...
        .depends_on(waste_logistics, ultimate_matrix)
        .checkmark()
        .finish()
    )
    sps = (
    ...
    antimatter_reserve = (
        chapter.quest(
            "antimatter_reserve",
            "A Strategic Antimatter Reserve",
            "mekanism:pellet_antimatter",
        ...
        .depends_on(antimatter, fusion_trial)
        .item("mekanism:pellet_antimatter", 4)
        .finish()
    )
    integrated_complex = (
        chapter.quest(
            "integrated_complex",
            "The Integrated Mekanism Complex",
        ...
        .depends_on(fusion_trial, black_start, antimatter)
        .checkmark()
        .finish()
    )
    industrial_trial = (
        ...
        .depends_on(integrated_complex, gear_trial)
        .checkmark()
        .finish()
    )
    mastery = (
        chapter.quest(
            "mekanism_endgame_mastery",
        ...
        .depends_on(industrial_trial, antimatter_reserve)
        .checkmark()
        .reward_item("mekanism:pellet_antimatter")
        .finish()
    )
    return mastery
